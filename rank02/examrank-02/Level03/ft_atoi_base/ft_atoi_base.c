...
/*   Updated: 2024/11/07 15:00:49 by mgodawat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("Base 16, Input \"%s\" -> Result: %d\n", test1, ft_atoi_base(test1,
			16));
	printf("Base 2, Input \"%s\" -> Result: %d\n", test2, ft_atoi_base(test2,
			2));
	printf("Base 16, Input \"%s\" -> Result: %d\n", test3, ft_atoi_base(test3,
			16));
	printf("Base 10, Input \"%s\" -> Result: %d\n", test4, ft_atoi_base(test4,
			10));
	printf("Base 16, Input \"%s\" -> Result: %d\n", test5, ft_atoi_base(test5,
			16));
	printf("Base 10, Input \"%s\" -> Result: %d\n", test6, ft_atoi_base(test6,
			10));
	printf("Base 16, Input \"%s\" -> Result: %d\n", test7, ft_atoi_base(test7,
			16));
	printf("Base 2, Input \"%s\" -> Result: %d\n", test8, ft_atoi_base(test8,
			2));
	return (0);
}
